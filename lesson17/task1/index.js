...
const sayTom = sayName;
sayTom.call(student);
sayTom.call({ name: 'Bruce' });
...
const func2 = getPopulation;
const population = func2.call(country, 43000);
...
const func3 = transaction.printTransaction;
func3.call(anotherTransaction);
